...
@onready var shockwave_upgrade_button: Button = $MainMargin/MainPanel/VBoxMain/ContentRow/MarginContainer/GridContainer/ShockwaveContainer/CenterContainer/VBoxContainer/ShockwaveUpgradeButton
